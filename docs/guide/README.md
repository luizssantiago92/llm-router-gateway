...
| File | Topic |
| --- | --- |
| **[Overview.md](Overview.md)** | What it is, how to use it, how much ceremony — **start here** |
| [Home.md](Home.md) | Short hub |
| [Quick-start.md](Quick-start.md) | First ten minutes (Compose + Gemini) |
| [How-it-works.md](How-it-works.md) | Request path in plain words |
| [concepts.md](concepts.md) | Cache key, complexity, fallback, quota |
