...
Status: **specified in the requirements brief**, not implemented yet. This page tracks the intended v1 shape from [`prd.md`](../prd.md) and [D-001–D-012](../.specs/features/llm-router-gateway/brief.md).
